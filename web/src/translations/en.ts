...
export const en = {
    ...
    'page.body.landing.marketInfo.title.text1': 'Welcome to APIX EXCHANGE.',
    ...
    'page.body.landing.register.item.text': 'APIX EXCHANGE offers an intuitive interface with real time orderbooks, charting tools, trade history, and a simple order process so you can trade from day one.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'APIX EXCHANGE platform features',
    ...
    'page.body.landing.features.features.item1.text': 'APIX EXCHANGE offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'APIX EXCHANGE offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.tradeOnTheGo.item.text3': 'All the power of APIX EXCHANGE cryptocurrency exchange, in the palm of your hand.',
    ...
    'page.body.landing.footer.info': 'Listing Information',
    'page.body.landing.footer.rights': 'APIX EXCHANGE © All rights reserved.',
